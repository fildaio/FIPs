...
从2021年1月5日20点（Beijing时间）上线以来，最高峰时平台存贷资金规模达到3.7亿美元，这远远超过我们的预想。感谢社区用户的青睐和信任，也让我们感受到无与伦比的压力和责任。

作为一个借贷平台，存款用户希望获得更高利息，贷款用户希望支付更低利息，我们很难做出正确的判断，随着资金规模增长，这让我们更加诚惶诚恐不敢独自决断，否则难免会受自身局限而做出错误判断，甚至还可能引发腐败问题。

为了能能公平公正的运转，让FilDA能代表大多数人和资金的利益，让各方诉求可以被倾听，可以以市场机制进行博弈实现最优解，这是FilDA DAO治理的核心目的。

​	FilDA 持有者、LP 提供者、开发团队有各自的权利与义务，伴随FilDA用户平台的逐步发展，FilDA平台的重要决策将通过DAO治理流程来重新定义和验证，由长期利益相关者来决定FilDA协议的长期发展方向。
...
​ DAO治理的第一步是先支持DAO V1.0投票，即将保险池Insurance Pool升级为DAO Pool。FilDA持有者将FilDA质押到DAO Pool后，将获得DAO治理的投票权，并仍将获得原保险池的FilDA激励。 DAO Pool针对路线图进行投票及重大事项的投票，第一次治理将投票是否通过FilDA DAO。

FilDA需要一群愿意长期一起成长、发展的伙伴来共同参与，看得越远，我们共同走得更远。FilDA DAO V1.0将会是现阶段的初始原型，FilDA DAO V2.0或将参考更多成熟项目的DAO治理创新，比如Curve，用户质押FilDA时可以选择质押周期，周期越长，其与协议共同承担的风险越大，则相应的FilDA也将激励长期同行者，相同数量的FilDA获得的投票权重越大、协议权益更大。

#### 创世治理

FilDA创世治理第一步实现信息透明，信息透明是协议进化的基础，是各方利益平衡的润滑剂。创世团队一直秉持透明原则，让协议各项信息公开，也是火币HECO网络第一个上线就公开代币分配、挖矿参数、利率模型等的借贷协议。目前FilDA已经完成了包括HBTC、USDT-HECO、HUSD、ETH、HT、ELA-HECO、HBCH、HBSV、HLTC、HDOT、HPT、HXTZ 13种资产，当前借贷总额已经超过3.5亿美金。由于每一种资产的增减将都直接关系到FilDA参与存借用户的直接相关利益，未来FilDA的产品的重大创新其中包括不限于增加创新区币种借贷，增加机枪池等功能等、未来FilDA挖矿代币分配、挖矿参数、利率模型等重大调整将均通过DAO投票决定是否进行变更和调整。
...
任何人都可以在社区内广泛征集意见并充分讨论形成提案，在本仓库打开一个PR来提交提案内容。在目前阶段，由FilDA团队审核提案内容并进行提交，在运行平稳，流程顺畅以后，FilDA团队会升级系统，支持社区自发提交提案。
...
为了激励FilDA用户参与DAO治理同时分享平台成长，平台将协议的保留资金池每周收入的20%分红给DAO池用户。
...
FilDA上线初期为了控制风险，并为了保护用户财产安全，设置的资产质押率仅为10%，在平稳发展一段时期后，FilDA才参考Huobi Global来调整质押率，且平均质押率均低于市场头部前三交易所和头部DEFI借贷协议。

#### FilDA DAO 治理池框架

FilDA DAO 治理池由原FilDA 保险池升级而来，当市场出现极端行情，储户本金遭受损失时，DAO治理池的部分资产（目前此比例设置为最大50%）将对储户进行补偿。
